...
export const ROLES_KEY = 'campusgo:roles';
export const IS_PUBLIC_KEY = 'campusgo:isPublic';
...
export const REFRESH_COOKIE_NAME = 'campusgo_rt';

/** Re-export role constants for convenience. */
export { UserRole, ADMIN_ROLES, isAdminRole, isStudentRole } from '@campusgo/shared';
