...
const DEMO_MAILTO = 'mailto:campusgo@campusgoindia.com?subject=Demo%20request';
      ...
      <header className="bg-[#0B1330]">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            <a href="#platform" className="text-sm font-medium text-white/75 hover:text-white">Platform</a>
            <a href="#readiness" className="text-sm font-medium text-white/75 hover:text-white">Readiness</a>
            <a href="#students" className="text-sm font-medium text-white/75 hover:text-white">For students</a>
            <a href="#reports" className="text-sm font-medium text-white/75 hover:text-white">Reports</a>
          </nav>
          <Link
            href="/login"
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid grid-cols-2 gap-8 border-b border-white/10 pb-10 sm:grid-cols-4">
            ...
            <div>
              ...
              <div className="mt-4 flex flex-col gap-2.5">
                <span className="text-sm text-white/65">About CampusGo</span>
                <a href="mailto:campusgo@campusgoindia.com" className="text-sm text-white/65 hover:text-white">Contact</a>
                <a href={DEMO_MAILTO} className="text-sm text-white/65 hover:text-white">Request a Demo</a>
